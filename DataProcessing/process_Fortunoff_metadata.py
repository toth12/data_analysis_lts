...
def get_marc_json():
  ...
  f = text.read(marc_xml_path, 'utf8')
...
def main():
  ...
  df['interviewee_year_of_birth'] = df.interviewee_year_of_birth.apply(get_year_of_birth)
  df.to_csv(constants.OUTPUT_FOLDER+'fortunoff_metadata.csv')
